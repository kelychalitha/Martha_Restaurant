...
<table width="80%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <!--search supplier - search bar-->
        <form action="result_supplier.php" method="get" ecntype="multipart/data-form">
        <input type="text" name="query" style="border:1px solid #CCC; color: #333; width:210px; height:30px; font-family: 'Comic Sans MS', cursive;" placeholder="Search supplier..." /><input type="submit" id="btnsearch" value="Search" name="search" />
        </form>
        
        </td>
        
        <td width="127" height="37" align="right">
        <a href="javascript:void(0)" onclick="toggle_visibility('popup-box1')"><input type="button" style="border:1px solid #066; background:#363636; height:45px; width:125px; color:#FFF; border-radius:3px; font-family:'Comic Sans MS', cursive;" value="+ Add Supplier" /></a></td>
      </tr>
  ...
  <tr>
    <td>
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #066; color:#8c0052; border-radius:3px;">
    
     <tr>
     <th colspan="6" align="center" height="55px" style="border-bottom:1px solid #033; background: #363636; color:#FFF;"> Supplier Information Table</th>
    </tr>
...
while ($row=mysqli_fetch_array($result)){?>
      ...
      <tr align="center" style="height:25px">
        ...
        <a href="edit_supplier.php?id=<?php echo md5($row['id']);?>"><input type="button" value="Edit" style="width:50px; height:20; color:#FFF; background:#72a400; font-family:'Comic Sans MS', cursive; border:1px solid #069; border-radius:3px;"></a>/<a href="delete_supplier.php?id=<?php echo md5($row['id']);?>"><input type="button" value="Delete" style="width:15; height:20; color:#FFF; font-family:'Comic Sans MS', cursive; background: #f44336; border:1px solid #900; border-radius:3px;"></a>
...
<div id="popup-container">
    ...
    <p style="font-family: 'Comic Sans MS', cursive;font-size:16px;"> Add Supplier Form </p>
    </div>
    <br>
