    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="80%" style="border:1px solid #033; color:#8c0052;">
     ...
     <th colspan="7" align="center" height="55px" style="border-bottom:1px solid #363636; background: #363636; color:#FFF;"> Products 	</th>
      ...
      <!--show product result-->
        ...
        <a href="edit_item.php?id=<?php echo md5($row1['id']);?>"><input type="button" value="Edit" style="width:50px; height:20; color:#FFF; background:#72a400; font-family: 'Comic Sans MS', cursive; border:1px solid #069; border-radius:3px;"></a>/<a href="delete_item.php?id=<?php echo md5($row1['id']);?>"><input type="button" value="Delete" style="width:15; height:20; color:#FFF; background: #f44336; font-family: 'Comic Sans MS', cursive; border:1px solid #900; border-radius:3px;"></a>
...
<tr>
	<td>Martha Restaurant &copy; 2021 </td>
</tr>
</table>
</div>
